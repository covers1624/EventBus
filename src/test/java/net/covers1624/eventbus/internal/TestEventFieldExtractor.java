...
public class TestEventFieldExtractor {
    ...
    public void testDuplicate() {
        ...
        assertEquals("Found duplicate Event field name 'hierarchy1'. Declared in 'net.covers1624.eventbus.internal.TestEventFieldExtractor$Hierarchy1' and 'net.covers1624.eventbus.internal.TestEventFieldExtractor$DuplicateH1'.", e.getMessage());
    }
    ...
    public void testNoGetter() {
        ...
        assertEquals("Getter for event field 'field' in class 'net.covers1624.eventbus.internal.TestEventFieldExtractor$NoGetter' required.", e.getMessage());
    }
    ...
    public void testClassNotInterface() {
        ...
        assertEquals("Expected interface. Got: class net.covers1624.eventbus.internal.TestEventFieldExtractor$ClassNotInterface", e.getMessage());
    }
